...
namespace WebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20240728125016_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Domain.Entities.DepositTransaction", b =>
                {
                    b.HasBaseType("WebAPI.Domain.Entities.Transaction");

                    b.HasDiscriminator().HasValue("Deposit");
                });

            modelBuilder.Entity("WebAPI.Domain.Entities.TransferTransaction", b =>
                {
                    b.HasBaseType("WebAPI.Domain.Entities.Transaction");
            ...
            modelBuilder.Entity("WebAPI.Domain.Entities.WithdrawTransaction", b =>
                {
                    b.HasBaseType("WebAPI.Domain.Entities.Transaction");
            ...
            modelBuilder.Entity("WebAPI.Domain.Entities.TransferTransaction", b =>
                {
                    b.HasOne("WebAPI.Domain.Entities.Account", "FromAccount")
                        .WithMany("OutgoingTransactions")
                        .HasForeignKey("FromAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebAPI.Domain.Entities.Account", "ToAccount")
            ...
            modelBuilder.Entity("WebAPI.Domain.Entities.Account", b =>
                {
                    b.Navigation("IncomingTransferTransactions");
